...
var mylocation = null;
var indices = ['economic_impact_index', 'education_impact_index', 'health_impact_index', 'social_impact_index']
...
function load_districts() { 
    ...
    xhr.open("GET","api/doves-dammam",true);
    xhr.send();
}
...
function getAreaColor(feature) {
    ...
    return colorRange(100.0-((total/(indices.length*100.0))*100.0));
};
...
function updateLegend(district, districtName) {
    ...
    $('.indicator').each((index, obj) => {
        ...
        obj.style.backgroundColor = colorRange(100.0-district[indicator]);
